<div class="header-section">
    ...
    <div class="logo">
      <div class="navbar-brand-wrapper h-100 w-100">
          <img class="h-100 w-100" src="/assets/admin/template1/images/se.jpg" alt="logo" />
      </div>
    </div>
        ...
        <ul class="nav navbar-nav">                           
            ...
            {{-- <li>
                <form class="search-content" action="index.html" method="post">
                    <input ng-model ="timKiem" type="text" class="form-control mt-3" name="keyword" placeholder="Search...">
            ...
            <ul class="notification-menu">
                    ...
                    <ul class="dropdown-menu mailbox dropdown-menu-right">
                        ...
                        <li class="notification-scroll">
                            <div class="message-center">
                                <a href="#">
                                    <div class="user-img">
                                        <img src="{{asset('assets/admin/template1/images/face1.jpg')}}" alt="user" class="rounded-circle"> 
                                ...
                                <a href="#">
                                    <div class="user-img">
                                        <img src="{{asset('assets/admin/template1/images/face4.jpg')}}" alt="user" class="rounded-circle"> 
                                ...
                                <a href="#">
                                    <div class="user-img">
                                        <img src="{{asset('assets/admin/template1/images/face3.jpg')}}" alt="user" class="rounded-circle"> 
                ...
                <li>
                    <a href="javascript:;" data-toggle="dropdown">
                        <img src="{{asset('assets/admin/template1/images/face2.jpg')}}" alt="">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right profile-menu">
                        <a class="dropdown-item" href="#"><i class="mdi mdi-account-circle m-r-5 text-muted"></i> Profile</a>
                        <a class="dropdown-item" href="#"><span class="badge badge-success pull-right">5</span><i class="mdi mdi-settings m-r-5 text-muted"></i> Settings</a>
                        <a class="dropdown-item" href="#"><i class="mdi mdi-lock-open-outline m-r-5 text-muted"></i> Lock screen</a>
                        <a class="dropdown-item" onclick="localStorage.removeItem('token')" href="{{asset('admin/login')}}"><i class="mdi mdi-logout m-r-5 text-muted"></i> Logout</a>
                    </div>
