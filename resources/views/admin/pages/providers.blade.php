            ...
            <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel"> @{{ deleting ? 'Xác nhận' : 'Thông tin nhà cung cấp' }} </h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div ng-if="!deleting" class="container-fluid">
                            <div class="row">
                                <div ng-repeat="f in fields | editable" ng-class="f.type != 'editor' ? 'col-12  col-md-6' : ''"
                                    class="form-group mb-3 col-12 col-md-6">
                                    <label for="@{{ f.field }}"
...
@section('scripts')
    <script src="/assets/admin/js/providerExtend.js"></script>
